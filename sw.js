const CACHE_NAME = 'contas-dona-neuza-github-v1';
const STATIC_ASSETS = [
  './',
  './index.html',
  './manifest.json',
...
self.addEventListener('install', (event) => {
  console.log('[SW] Instalando Contas Dona Neuza (GitHub Edition)...');
  event.waitUntil(
...
self.addEventListener('activate', (event) => {
  console.log('[SW] Ativando Contas Dona Neuza...');
  event.waitUntil(
...
self.addEventListener('fetch', (event) => {
  ...
  // Ignorar requisições para a API do GitHub (não cachear)
